...
const FilmBadge = ({ rating, isColorfulBadge }: FilmBadgeProps) => {
    ...
    return (
        <div
            class={`css-film-badge absolute text-black flex flex-col items-center text-sm gap-0 p-1 min-w-[24px] right-0 top-0 rounded-tl-sm rounded-br-sm rounded-tr-lg rounded-bl-lg ${ratingColor}`}
        >
