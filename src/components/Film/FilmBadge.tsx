...
const FilmBadge = ({ rating, isColorfulBadge }: FilmBadgeProps) => {
    ...
    return (
        <div
            class={`css-film-badge absolute text-black flex flex-col items-center text-[15px] gap-0.5 px-1.5 py-1 min-w-[28px] right-0 top-0 rounded-tl-sm rounded-br-sm rounded-tr-lg rounded-bl-lg ${ratingColor}`}
        >
