...
export class Film {
    ...
    async applyStylesToFilmPoster() {
        ...
        const aTag = (await waitForElement(this.filmElement, "a.frame", {
            timeout: 150000,
            pauseTimeoutWhileHidden: true
        })) as HTMLElement | undefined;
        const overlay = (await waitForElement(this.filmElement, "span.overlay", {
            timeout: 150000,
            pauseTimeoutWhileHidden: true
        })) as HTMLElement | undefined;
        const overlayActions = (await waitForElement(this.filmElement, "span.overlay-actions", {
            timeout: 150000,
            pauseTimeoutWhileHidden: true
        })) as HTMLElement | undefined;
        const imgElement = (await waitForElement(this.filmElement, "img.image", {
            timeout: 150000,
            pauseTimeoutWhileHidden: true
        })) as HTMLElement | undefined;
